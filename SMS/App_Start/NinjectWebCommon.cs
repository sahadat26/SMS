...
namespace SMS.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<ISalesCommissionRepository>().To<SalesCommissionRepository>();
            kernel.Bind<IReportRepository>().To<ReportRepository>();
            kernel.Bind<IConditionMatrixRepository>().To<ConditionMatrixRepository>();
            kernel.Bind<ISPServiceRepository>().To<SPServiceRepository>();
        }        
    }
}
